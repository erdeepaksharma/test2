...
<!-- LOGIN-->
    <div id="checkout" class="panel-group">
      <div class="panel panel-primary">
        <div class="checkout-heading panel-heading" style="font-size: 16px; padding-left: 20px;"><?php echo $text_checkout_option; ?></div>
        <div class="checkout-content panel-collapse collapse"></div>
        
      </div>
    </div>
<!-- PAYMENT ADDRESS-->
    <?php if (!$logged) { ?>
     <div id="payment-address" class="panel-group">
         <div class="panel panel-primary">
      <div class="checkout-heading panel-heading" style="font-size: 16px; padding-left: 20px;"><span><?php echo $text_checkout_account; ?></span></div>
      <div class="checkout-content panel-collapse collapse"></div>
     ...
     <div id="payment-address" class="panel-group">
         <div class="panel panel-primary">
      <div class="checkout-heading panel-heading" style="font-size: 16px; padding-left: 20px;"><span><?php echo $text_checkout_payment_address; ?></span></div>
      <div class="checkout-content panel-collapse collapse"></div>
...
<!-- SHIPPING ADDRESS-->
    <div id="shipping-address" class="panel-group">
<div class="panel panel-primary">
    <div class="checkout-heading  panel-heading" style="font-size: 16px; padding-left: 20px;"><?php echo $text_checkout_shipping_address; ?></div>
      <div class="checkout-content panel-collapse collapse"></div>
      
</div>
    </div>
<!-- SHIPPING METHOD-->
    <div id="shipping-method" class="panel-group">
<div class="panel panel-primary">
      <div class="checkout-heading  panel-heading" style="font-size: 16px; padding-left: 20px;"><?php echo $text_checkout_shipping_method; ?></div>
      <div class="checkout-content panel-collapse collapse"></div>
    ...
    <?php } ?>
<!-- AYMENT METHOD-->
    <div id="payment-method" class="panel-group">
<div class="panel panel-primary">
      <div class="checkout-heading  panel-heading" style="font-size: 16px; padding-left: 20px;"><?php echo $text_checkout_payment_method; ?></div>
      <div class="checkout-content panel-collapse collapse"></div>
      
</div>
    </div>
<!-- CONFIRM-->
    <div id="confirm" class="panel-group">
<div class="panel panel-primary">
      <div class="checkout-heading panel-heading" style="font-size: 16px; padding-left: 20px;"><?php echo $text_checkout_confirm; ?></div>
      <div class="checkout-content panel-collapse collapse"></div>
...
$('#button-account').live('click', function() {
	...
	$.ajax({
		...
		success: function(html) {
			...
			$('#checkout .checkout-heading').append('<a data-toggle="collapse" style="float: right; color:#ffffff;"><?php echo $text_modify; ?></a>');
				...
				if (shipping_address) {
					...
					$.ajax({
						...
						success: function(html) {
							...
							$('#shipping-address .checkout-heading').append('<a data-toggle="collapse" style="float: right; color:#ffffff;"><?php echo $text_modify; ?></a>');									

							$('#payment-address .checkout-heading').append('<a data-toggle="collapse" style="float: right; color:#ffffff;"><?php echo $text_modify; ?></a>');	
			...
			if (json['redirect']) {
				...
				$.ajax({
					...
					success: function(html) {
						...
						$('#shipping-method .checkout-heading').append('<a data-toggle="collapse" style="float: right; color:#ffffff;"><?php echo $text_modify; ?></a>');	
			...
			if (json['redirect']) {
				...
				$.ajax({
					...
					success: function(html) {
						...
						$('#payment-method .checkout-heading').append('<a data-toggle="collapse" style="float: right; color:#ffffff;"><?php echo $text_modify; ?></a>');	
